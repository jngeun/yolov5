...
def plot_one_label(x, img, color=None, label=None, line_thickness=1):
    ...
    if label:
        ...
        if (center[0] >= w / 2) and (center[1] < h / 2): #1사분면
            ...
            cv2.line(img, pnt, center, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
            cv2.putText(img, label, (pnt[0] - t_size[0],pnt[1] + t_size[1]), 0, tl / 2, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
        elif (center[0] < w / 2) and (center[1] < h / 2): #2사분면
            pnt = (center[0] + e, center[1] + e)
            cv2.line(img, (pnt[0],pnt[1] - t_size[1]), center, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
            cv2.putText(img, label, pnt, 0, tl / 2, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
            ...
            pnt = (center[0] - e , center[1] - e)
            cv2.line(img, pnt, center, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
            cv2.putText(img, label, (pnt[0] - t_size[0],pnt[1]), 0, tl / 2, [255, 110, 67], thickness=tf, lineType=cv2.LINE_AA)
